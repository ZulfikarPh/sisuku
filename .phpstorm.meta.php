...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\sisuku\public\storage' => 'string',
...
'delete','denyWithStatus','denyAsNotFound',);
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\sisuku\\public\\storage','logging.default',
...
'sanctum.token_prefix','sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','livewire.class_namespace',
...
'SESSION_LIFETIME','QUEUE_CONNECTION','CACHE_STORE','MAIL_MAILER','MAIL_HOST',
'MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS',
'MAIL_FROM_NAME','BCRYPT_ROUNDS','REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD',
'REDIS_PORT','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET',
